...
def game():
    ...
    turnNum = "0"
    cellNum = "0"
    # The last number is the depth
    # IF YOU CHANGE IT, MAKE SURE TO CHANGE THE NUMBER YOU CALL ALPHABETACALLS WITH TO THE SAME NUMBER
    reina = Reina0(turnNum, cellNum, color, cellsplaced, 8)
